...
When we are evaluating our confidence in the reliability of a sample mean, we don't use the standard deviation. The **standard deviation of the mean** describes the spread of a sample's distribution (rather than a population's)—how different, in general, are observations from the mean?
